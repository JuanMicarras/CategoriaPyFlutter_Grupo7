          ...
          child: Column(
            ...
            children: [
              ...
              if (isVisible) ...[
                if (myPeerData != null)
                  PeerEvaluationCard(
                    ...
                    canExpand: isVisible, // 🔥 CONTROL VISIBILITY
                    puntualidad: PeerEvaluationData(
                      subtitle: "Promedio",
                      score: controller.getMyScoreText("Puntualidad"),
                    ),
                    contribucion: PeerEvaluationData(
                      subtitle: "Promedio",
                      score: controller.getMyScoreText("Contribución"),
                    ),
                    compromiso: PeerEvaluationData(
                      subtitle: "Promedio",
                      score: controller.getMyScoreText("Compromiso"),
                    ),
                    actitud: PeerEvaluationData(
                      subtitle: "Promedio",
                      score: controller.getMyScoreText("Actitud"),
                    ),
              ...
              ...otherPeers.map((peer) {
                ...
                final isSubmitting = controller.isPeerSubmitting(peer.email);
                  ...
                  child: Column(
                    children: [
                      EditablePeerEvaluationCard(
                        ...
                        progressText: controller.getEvaluationStatusText(
                          peer.email,
                          widget.isExpired,
                        ),
                        initiallyExpanded: false,
                        ...
                        canExpand:
                            true,
                        initialPuntualidad: controller.getSavedScoreForPeer(
                          peer.email,
                          "Puntualidad",
                        ),
                        initialContribucion: controller.getSavedScoreForPeer(
                          peer.email,
                          "Contribución",
                        ),
                        initialCompromiso: controller.getSavedScoreForPeer(
                          peer.email,
                          "Compromiso",
                        ),
                        initialActitud: controller.getSavedScoreForPeer(
                          peer.email,
                          "Actitud",
                        ),
