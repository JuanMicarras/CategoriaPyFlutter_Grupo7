  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Text(
        ...
        style: AppTheme.bodyM.copyWith(
          fontWeight: FontWeight.w400,
          color: isLight ? const Color(0xFF637488) : AppTheme.darkTextMuted,
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isLight ? AppTheme.secondaryColor : AppTheme.darkBorder,
          width: 1,
        ),
      ),
      child: TextField(
        ...
        child: Row(
          children: [
            ...
            Icon(
              ...
              size: 20,
              color: isLight ? const Color(0xFF94A3B8) : AppTheme.darkTextMuted,
            ),
          ],
        ),
      ),
